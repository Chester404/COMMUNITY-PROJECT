...
export default function ProductPage({}) {
  ...
  useEffect(() => {
    axios.get(`http://51.116.114.155:8080/marketplace/products/${owner.id}`).then(
      (response) => {
...
return (
    <MainLayout title={productData.name}>
      ...
      <div className="row mb-6">
        ...
        <Link href="/products/edit/[id]" as={`/products/edit/${product.owner.id}`}>
            <button
