                ...
                <tbody>
                  ...
                  <th scope="row">     
                                    ...
                                    <div className="row">
                                        ...
                                        <img src="../images/profileImage1.png" className="img-fluid rounded-circle mr-3" alt="profile pic" />
                                            ...
                                            <div className="dropdown-menu">
                                                <div className="dropdown-item" >
                                                    <div className="row">
                                                        ...
                                                        <a className="dropdown-item" href="#">Kristine Wonder</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="dropdown-item" >
                                                    <div className="row">
                                                        ...
                                                        <div className="col dropdown_contact">
                                                            <a className="dropdown-item">+233 050 123 9876</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="dropdown-item">
                                                    <div className="row">
                                                        ...
                                                        <div className="col dropdown_email">
                                                            <p className="dropdown-item" >wonder1993@gmail.com</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="dropdown-item">
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col dropdown_address2">
                                                            <p className="dropdown-item">Executive Avenue 123 </p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="dropdown-menu">
                                                ...
                                                <a className="dropdown-item" href="#">
                                                    <div className="row">
                                                        ...
                                                        <div className="col">
                                                            <a className="dropdown-item" href="#">+233 050 123 9876</a>
                                                        </div>
                                                    </div>
                                                </a>
                                                <a className="dropdown-item" href="#">
                                                    <div className="row">
                                                        ...
                                                        <div className="col">
                                                            <a className="dropdown-item" href="#">wonder1993@gmail.com</a>
                                                        </div>
                                                    </div>
                                                </a>
                                                ...
                                                <a className="dropdown-item" href="#">
                                                    <div className="row">
                                                        ...
                                                        <div className="col">
                                                            <a className="dropdown-item" href="#">Executive Avenue 123, Anaji</a>
                                                        </div>
                                                    </div>
                                                </a>
                                                </a>
