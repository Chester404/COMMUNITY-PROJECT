...
function profilelist_unregistered() {
    return(
        <Layout title="Profile List unregistered viewer">
      <Head>
                                    ...
                                    <div className="row">
                                        ...
                                        <img src="../images/profileImage1.png" className="img-fluid rounded-circle mr-3" alt="profile pic" />
                                            ...
                                            <div className="dropdown-menu">
                                                ...
                                                <div className="dropdown-item" >
                                                    <div className="row">
                                                        <div className="col dropdown_moreinfo">
                                                            <p>For more information please register <br/>an <Link href="/auth/signup"><a  id="signup">account</a></Link> </p>
                                                        </div>                                                        
                                                    </div>
                                                </div>
...
export default profilelist_unregistered;